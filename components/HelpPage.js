  ...
  const faqItems = [
    {
      ...
      answer: "Tap the + button on the main screen, then fill in the medication details including name, dosage, schedule, and current stock. You can also set reminders for when to take your medication."
    },
    {
      id: 2,
      question: "What does the SOS button do?",
      answer: "The SOS button provides quick access to emergency contacts and information in case of a medical emergency. It contains your critical health information and emergency contact numbers."
    },
    {
      id: 3,
      question: "How can I check for potential drug interactions?",
      answer: "Go to the Pharmacy tab and select 'Check Interactions' on your medication. You can also use the OpenFDA resource link in the Resources section of this Help page."
    },
    {
      id: 4,
      question: "How do I update my medication schedule?",
      answer: "Go to the Schedule tab, select the medication you want to update, then tap 'Edit Schedule' to change your medication timing or frequency."
    },
    {
      id: 5,
      question: "What do I do when my medication is running low?",
      answer: "When a medication is running low, you'll see a 'STOCK LOW' warning on the Dashboard. Tap on the medication to quickly request a refill or set a reminder to refill it."
    }
  ];
  ...
  return (
    <div className="bg-white w-full min-h-screen flex flex-col">
      ...
      <div className="flex justify-between items-center border-2 border-black rounded-lg p-2 m-2 overflow-x-auto">
        <button 
          className={`font-bold whitespace-nowrap px-2 md:px-4 ${location.pathname === "/pharmacy" ? "text-blue-600" : ""}`}
          onClick={() => navigate("/pharmacy")}
        >
          Pharmacy
        </button>
        <button 
          className={`font-bold whitespace-nowrap px-2 md:px-4 ${location.pathname === "/profile" ? "text-blue-600" : ""}`}
          onClick={() => navigate("/profile")}
        >
          Profile
        </button>
        <button 
          className={`font-bold whitespace-nowrap px-2 md:px-4 ${location.pathname === "/settings" ? "text-blue-600" : ""}`}
          ...
          <div ref={guidelinesRef} className="mb-8">
            ...
            <div className="border-2 border-black rounded-lg p-4">
              ...
              <ul className="list-disc list-inside mb-4 space-y-2">
                <li>Add your medications through the + button on the Dashboard</li>
            ...
            <div className="border-2 border-black rounded-lg p-4">
              ...
              <div className="space-y-3">
                <div className="border border-gray-200 rounded-lg p-3">
                  ...
                  <p className="text-sm mb-2">Check potential interactions between your medications and food or other drugs.</p>
                ...
                <div className="border border-gray-200 rounded-lg p-3">
                  ...
                  <p className="text-sm mb-2">Access official medication guides for your prescriptions.</p>
                  <button className="text-blue-600 text-sm flex items-center">
                    Visit Resource <ExternalLink size={14} className="ml-1" />
                  </button>
                </div>
                ...
                <div className="border border-gray-200 rounded-lg p-3">
                  ...
                  <p className="text-sm mb-2">Learn about food-drug interactions and dietary recommendations.</p>
                  <button className="text-blue-600 text-sm flex items-center">
                    Visit Resource <ExternalLink size={14} className="ml-1" />
                  </button>
                </div>
      ...
      <div className="flex justify-between px-4 pb-4 mt-auto">
        <button 
          className={`border-2 border-black rounded-lg py-2 px-2 md:px-4 w-1/2 mr-2 font-bold ${
            location.pathname === "/" || location.pathname === "/dashboard" ? "bg-gray-200" : ""
          }`}
