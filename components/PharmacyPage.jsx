  ...
  const pharmacyData = [
    {
      ...
      medicines: [
        ...
        { name: "Amoxicillin", inStock: false, price: 12.5 },
    ...
    },
    {
      ...
      phone: "(123) 555-7890",
      medicines: [
        { name: "Paracetamol", inStock: true, price: 6.5 },
        { name: "Amoxicillin", inStock: true, price: 11.99 },
        { name: "Metformin", inStock: true, price: 7.3 },
      ],
    },
    {
      id: 3,
      ...
      medicines: [
        ...
        { name: "Metformin", inStock: false, price: 7.5 },
      ],
    },
    {
      id: 4,
      ...
      phone: "(123) 777-8989",
      medicines: [
        { name: "Paracetamol", inStock: true, price: 5.5 },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
            {filteredPharmacies.length > 0 ? (
              filteredPharmacies.map((pharmacy) => {
                const medicineStatus = checkMedicineAvailability(
                  pharmacy,
                  searchQuery
                );
                      ...
                      <div className="mt-2 p-2 bg-blue-50 rounded">
                        {medicineStatus.available ? (
                          <p className="flex items-center text-green-600 text-sm">
                            ...
                            {searchQuery} is in stock - $
                            {medicineStatus.price.toFixed(2)}
                          </p>
                        ) : (
              ...
              <div className="p-6">
                ...
                <div className="mt-4">
                  ...
                  <p className="text-blue-600">
                    {selectedPharmacy.distance} miles away
                  </p>
                        ...
                        >
                          ...
                          {medicine.inStock ? (
                            ...
                            <span className="flex items-center text-red-500 text-sm">
                              <XCircle size={16} className="mr-1" /> Out of
                              Stock
                            </span>
                          )}
                        </div>
